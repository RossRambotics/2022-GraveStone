...
public class Intake extends SubsystemBase {
  ...
  public Intake() {
    ...
    m_rollerMotor.configPeakOutputForward(1, IntakeConstants.kTimeoutMs);
    m_rollerMotor.configPeakOutputReverse(-1, IntakeConstants.kTimeoutMs);
    ...
    m_extensionMotor.configPeakOutputForward(1, IntakeConstants.kTimeoutMs);
    m_extensionMotor.configPeakOutputReverse(-1, IntakeConstants.kTimeoutMs);
  ...
  class IntakeConstants {
    ...
    public static final double m_defaultExtensionDegrees = 90;
    public static final double m_ticksPerDegree = 2048 * 4 / 360;
  }
  ...
  public void extend() {
    // Extends arm
    double targetTicks = IntakeConstants.m_ticksPerDegree * m_targetExtensionDegrees.getDouble(90);
