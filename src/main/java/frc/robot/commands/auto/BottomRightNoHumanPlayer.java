...
public class BottomRightNoHumanPlayer extends CommandBase {
  private DrivetrainSubsystem m_driveSub = null;

  /** Creates a new BottomRightNoHumanPlayer. */
  public BottomRightNoHumanPlayer(DrivetrainSubsystem driveSubsytem) {
  ...
  public void initialize() {
    PathPlannerTrajectory examplePath = PathPlanner.loadPath("3.0 BBR (no human player))", 3, 1);
