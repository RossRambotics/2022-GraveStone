...
public class BottomRightHumanPlayer extends CommandBase {
  private DrivetrainSubsystem m_driveSub = null;

  /** Creates a new BottomRightHumanPlayer. */
  public BottomRightHumanPlayer(DrivetrainSubsystem driveSubsytem) {
  ...
  public void initialize() {
    PathPlannerTrajectory examplePath = PathPlanner.loadPath("4.1 BBR (human player))", 3, 1);
