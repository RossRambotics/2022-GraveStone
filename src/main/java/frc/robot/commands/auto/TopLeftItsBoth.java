...
public class TopLeftItsBoth extends CommandBase {
  private DrivetrainSubsystem m_driveSub = null;

  /** Creates a new TopLeftItsBoth. */
  public TopLeftItsBoth(DrivetrainSubsystem driveSubsytem) {
  ...
  public void initialize() {
    PathPlannerTrajectory examplePath = PathPlanner.loadPath("7.1 BTL (ITS BOTH))", 3, 1);
