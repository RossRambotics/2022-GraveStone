...
public class BackAndShoot extends CommandBase {
  ...
  public void initialize() {
    ...
    PPSwerveControllerCommand runPath = new PPSwerveControllerCommand(
      ...
      SequentialCommandGroup command = new SequentialCommandGroup(new ExtendIntake().withTimeout(1), runPath, new ShootHigh().withTimeout(5), new RetractIntake().withTimeout(1));
