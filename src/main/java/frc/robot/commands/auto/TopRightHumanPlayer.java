...
public class TopRightHumanPlayer extends CommandBase {
  private DrivetrainSubsystem m_driveSub = null;

  /** Creates a new TopRightHumanPlayer. */
  public TopRightHumanPlayer(DrivetrainSubsystem driveSubsytem) {
  ...
  public void initialize() {
    PathPlannerTrajectory examplePath = PathPlanner.loadPath("6.1 BTR (human player))", 3, 1);
