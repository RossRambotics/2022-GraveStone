...
public class TopRightNoHumanPlayer extends CommandBase {
  private DrivetrainSubsystem m_driveSub = null;

  /** Creates a new TopRightNoHumanPlayer. */
  public TopRightNoHumanPlayer(DrivetrainSubsystem driveSubsytem) {
  ...
  public void initialize() {
    PathPlannerTrajectory examplePath = PathPlanner.loadPath("5.0 BBR (no human player))", 3, 1);
